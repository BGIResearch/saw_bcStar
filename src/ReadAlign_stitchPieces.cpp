...
#ifdef DEBUGOUT
//  cout<<"nP is "<<nP<<endl;
//  cout<<"index in nP\talign pos in Genome\talign strand\ttype(sj or normal)"<<endl;
#endif
...
//			  cout<<iP<<"\t"<<a1<<"\t"<<aStr<<"\t";
#endif
				// a1是比对位置，如果超过基因组fasta长度，那么就属于sj align
...
//         };
//
        if (WlastAnchor[iW]<nWA[iW]) { //上一个anchor索引位置小于anchor数量
