...
class Parameters {
    ...
    public:
        ...
        struct {bool NH,HI,AS,NM,MD,nM,jM,jI,RG,XS,rB,vG,vA,vW,ch,MC,CR,CY,UR,UY,Cx,Cy;} outSAMattrPresent, outSAMattrPresentQuant;
...
//    int inputFileNumber;
    uint Lread;
#ifdef TIME_STAT
    uint64_t loadGenomeTime,loadMaskTime,sortBamTime;
#endif
